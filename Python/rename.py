...
def move_file(select_file_name_list,old_path,new_path):
...
str_cond = 'car'#正则条件
old_path = r'C:\Users\Administrator\Desktop\挑图\其他'#原文件夹路径
new_path = r'C:\Users\Administrator\Desktop\挑图\其他\川'#新文件夹路径
